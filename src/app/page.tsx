    ...
    <>
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-forest-900/40 border border-forest-700/30 rounded-full px-4 py-1.5 text-forest-300 text-sm mb-6">
          ...
          <p className="text-xl sm:text-2xl text-forest-300 font-playfair italic mb-6">
